...
import { uploadPhoto, upload, getPhotos, getDeletedPhotos, restorePhoto, permanentDeletePhoto, streamThumbnail, streamOriginal, deletePhoto } from '../controllers/photo.controller';
